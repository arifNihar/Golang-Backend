...
import (
	...
	"modulus-restaurant-management/models"
	"net/http"
	"time"
...
func GetOrderItemsByOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while listing oreder items by order ID"})
			return
		}
		c.JSON(http.StatusOK, allOrderItems)
	}
